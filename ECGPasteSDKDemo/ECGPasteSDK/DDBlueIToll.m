...
//        return [DDBlueIToll colorWithHexString:@"#75c349"];
//    }else if (value > 0.05 & value<= 0.1){
//        return [DDBlueIToll colorWithHexString:@"#f1bb33"];
//    }else if (value >0.1 & value <=0.3){
//        return [DDBlueIToll colorWithHexString:@"#ff9c50"];
//    }else if (value > 0.3 & value <= 0.8){
//        return [DDBlueIToll colorWithHexString:@"#f27649"];
//    }else if (value >0.8 & value <= 1.0){
//        return [DDBlueIToll colorWithHexString:@"#4f0039"];
//    }else{
//        return [DDBlueIToll colorWithHexString:@"#ff1717"];
//
//    }
//}
...
//        return [DDBlueIToll colorWithHexString:@"#ab3f56"];
//
//    }else if (value >= 301 & value <= 500){
//        return [DDBlueIToll colorWithHexString:@"#7c1b39"];
//
//    }else {
//        return [DDBlueIToll colorWithHexString:@"#ff1717"];
//    }
...
- (NSMutableArray *) handleTheBLEFirstData:(NSMutableArray *)dataArr{
    ...
    NSString *str1 = [DDBlueIToll handStrtoulStr1:dataArr[4] andStr2:dataArr[5]];
    NSString *str2 = [DDBlueIToll handStrtoulStr1:dataArr[6] andStr2:dataArr[7]];
    NSString *str3 = [DDBlueIToll handStrtoulStr1:dataArr[8] andStr2:dataArr[9]];
    NSString *str4 = [DDBlueIToll handStrtoulStr1:dataArr[10] andStr2:dataArr[11]];
    NSString *str5 = [DDBlueIToll handStrtoulStr1:dataArr[12] andStr2:dataArr[13]];
    NSString *str6 = [DDBlueIToll handStrtoulStr1:dataArr[14] andStr2:dataArr[15]];
    
    NSUInteger pm2V = [[DDBlueIToll alloc] conversionPM2USAValue:str5];
    NSUInteger pm10V = [[DDBlueIToll alloc] conversionPM10USAValue:str6];
    NSUInteger pm2VC = [[DDBlueIToll alloc] conversionPM2ChinaValue:str5];
    NSUInteger pm10VC = [[DDBlueIToll alloc] conversionPM10ChinaValue:str6];
...
- (NSMutableArray *) handleTheBLETWOData:(NSMutableArray *)dataArr{
    ...
    NSString *jia = [DDBlueIToll handStrtoulStr1:dataArr[8] andStr2:dataArr[9]];
    
    NSString * humidity = [DDBlueIToll handStrtoulStr1:dataArr[10] andStr2:dataArr[11]];
    NSString * tempdity = [DDBlueIToll handStrtoulStr1:dataArr[12] andStr2:dataArr[13]];
...
/// 打印日志
/// @param logStr 内容
+(void)DDLog:(NSString *)logStr{
    if (![[NSUserDefaults standardUserDefaults]boolForKey:@"DDProduction"]) {
        NSLog(@"%@",logStr);
    }
